...
This project is an Android application built using Kotlin and Jetpack Compose. It is a single-activity app that recreates a student dashboard screen. 
The dashboard consists of a custom navigation bar that displays the student's name, followed by two sections: a timetable(Events and submission) for the day and a list of available 
car parks. The data is represented locally using fictitious values.
